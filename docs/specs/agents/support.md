...
The embedded skills catalog is documented in [skills.md](skills.md). It records official Agent Skills directories from Anthropic and OpenAI and supports selected-skill installation during `acps init`.
