...
src/
  ...
  runtime/
    ...
    agent_installer.rs            shell + registry-resolved installer (1- or 2-step)
    agent_registry.rs             embedded data/registry.toml loader + lookup
