...
`acp-stack` speaks ACP protocol v1 via the [agent-client-protocol](https://crates.io/crates/agent-client-protocol) Rust SDK, currently declared at 1.3.0 in `Cargo.toml`.
