...
pub(crate) const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        id: 23,
        name: "commands_origin",
        sqlite_file: "023_commands_origin.sqlite.sql",
        postgres_file: "023_commands_origin.postgres.sql",
    ...
    Migration {
        id: 25,
        name: "deps_apply_runs",
        sqlite_file: "025_deps_apply_runs.sqlite.sql",
        postgres_file: "025_deps_apply_runs.postgres.sql",
        sqlite: include_str!("../../migrations/025_deps_apply_runs.sqlite.sql"),
        postgres: include_str!("../../migrations/025_deps_apply_runs.postgres.sql"),
    },
    Migration {
        id: 26,
        name: "commands_terminal_id",
        sqlite_file: "026_commands_terminal_id.sqlite.sql",
        postgres_file: "026_commands_terminal_id.postgres.sql",
        sqlite: include_str!("../../migrations/026_commands_terminal_id.sqlite.sql"),
        postgres: include_str!("../../migrations/026_commands_terminal_id.postgres.sql"),
    },
    Migration {
        id: 27,
        name: "prompt_agent_message_ids",
        sqlite_file: "027_prompt_agent_message_ids.sqlite.sql",
        postgres_file: "027_prompt_agent_message_ids.postgres.sql",
        sqlite: include_str!("../../migrations/027_prompt_agent_message_ids.sqlite.sql"),
        postgres: include_str!("../../migrations/027_prompt_agent_message_ids.postgres.sql"),
    },
    Migration {
        id: 28,
        name: "installer_runs_artifact",
        sqlite_file: "028_installer_runs_artifact.sqlite.sql",
